...
ADD conf/lighttpd/lighttpd.conf /etc/lighttpd/lighttpd.conf
ADD conf/lighttpd/10-cgi.conf /etc/lighttpd/conf-available/10-cgi.conf
ADD conf/lighttpd/10-fastcgi.conf /etc/lighttpd/conf-available/10-fastcgi.conf
ADD conf/lighttpd/15-fastcgi-php.conf /etc/lighttpd/conf-available/15-fastcgi-php.conf

ADD conf/smokeping/smokeping.fcgi /usr/share/smokeping/www/smokeping.fcgi
